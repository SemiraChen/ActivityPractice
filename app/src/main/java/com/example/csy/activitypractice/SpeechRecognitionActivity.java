...
public class SpeechRecognitionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText iatText;
    @BindView(R.id.iat_contacts)
    EditText iatContacts;
    ...
    private void initLayout() {
        findViewById(R.id.iat_recognize).setOnClickListener(SpeechRecognitionActivity.this);
        findViewById(R.id.iat_recognize_stream).setOnClickListener(SpeechRecognitionActivity.this);
        findViewById(R.id.iat_upload_contacts).setOnClickListener(SpeechRecognitionActivity.this);
        findViewById(R.id.iat_upload_userwords).setOnClickListener(SpeechRecognitionActivity.this);
        findViewById(R.id.iat_stop).setOnClickListener(SpeechRecognitionActivity.this);
        findViewById(R.id.iat_cancel).setOnClickListener(SpeechRecognitionActivity.this);
        findViewById(R.id.image_iat_set).setOnClickListener(SpeechRecognitionActivity.this);
    }
    ...
    private InitListener mInitListener = new InitListener() {
        ...
        public void onInit(int code) {
            Log.d("CSY科大", "SpeechRecognizer init() code = " + code);
    ...
    private void printResult(RecognizerResult results) {
        ...
        //  l.setText(resultBuffer.toString());
...
//                startActivity(intents);
    ...
    public void setParam() {
        ...
        this.mTranslateEnable = mSharedPreferences.getBoolean("55", false);
        if (mTranslateEnable) {
